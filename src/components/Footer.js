              ...
              <div className='row'>
                ...
                <div className='col-3'>
                  <div className='ftr-menu-2 ftr-menu-3 ftr-title'>
                    ...
                    <ul className='clearfix reset-list'>
                      <li><Link><i class="ri-map-pin-fill"></i> Sajid</Link></li>
                      <li><Link><i class="ri-phone-fill"></i>  +000120000</Link></li>
                      <li><Link><i class="ri-phone-fill"></i>  +000120000</Link></li>
                      <li><Link><i class="ri-mail-line"></i> mzahid705@gmail.com</Link></li>
                    </ul>
                  </div>
                </div>
                <div className='col-3'>
           ...
           <div className='container'>
             <div className='row'>
                <div className='col-12'>
                  <p>Copyright © 2023 Sajid All Rights Reserved.</p>
                </div>
             </div>
           </div>
         </div>
